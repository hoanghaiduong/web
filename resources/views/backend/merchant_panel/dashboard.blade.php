                ...
                <div class="ecommerce-widget merchant-dashboard-filter">
                    <div class="row p-0 mb-3">
                        ...
                        <div class="col-12 col-md-6 text-right  pt-2 pt-sm-0">
                            <form action="{{route('merchant-panel.dashboard.filter')}}" method="POST" class="d-flex justify-content-end">
                                @csrf
                                <input type="text" autocomplete="off" id="date" name="date" class="input py-1 w200 date_range_picker w-50 form-control group-input " value="{{ isset($request->date) ? $request->date : old('date') }}" placeholder="{{ __('merchantPlaceholder.date') }}">
                                <button type="submit" class="btn btn-sm btn-primary group-btn" style="margin-left: -5px!important"><i class="fa fa-search"></i> {{ __('levels.filter') }}</button>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="row py-3  ">
                                    <div class="col-md-4">
                                        <ul class="list-group mt-2 ">
                                            ...
                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold"> {{ __('dashboard.net_profit_ammount') }}</span>
                                                <span class="float-right"> {{settings()->currency}}{{ $t_cash_collection - $t_selling_price }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="list-group mt-2 ">
                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold">{{ __('dashboard.total_liquid_fragile_amount') }}</span>
                                                <span class="float-right">{{settings()->currency}}{{ $t_liquid_fragile }}</span>
                                            </li>
                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold">{{ __('dashboard.total_packaging_amount') }}</span>
                                    ...
                                    <div class=" col-md-4 p-b-2 border-dark">
                                        <ul class="list-group mt-2 ">
                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold">{{ __('dashboard.total_delivery_charge') }}</span>
                                                <span class="float-right">{{settings()->currency}}{{ $t_delivery_charge }}</span>
                                            </li>
                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold">{{ __('dashboard.total_cod_amount') }}</span>
                                                <span class="float-right">{{settings()->currency}}{{ $t_cod_amount }}</span>
                                            </li>

                                            <li class="list-group-item profile-list-group-item">
                                                <span class="float-left font-weight-bold">{{ __('dashboard.total_total_delivery_amount') }}</span>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3  text-primary">{{settings()->currency}}{{number_format($t_sale,2)}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3  text-primary">{{settings()->currency}}{{number_format($t_delivery_fee,2)}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3 text-primary">{{settings()->currency}}{{ number_format($ts_vat,2) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3  text-primary">{{settings()->currency}}{{ number_format($t_sale - $t_delivery_fee-$ts_vat,2) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3 text-primary">{{settings()->currency}}{{ number_format($merchant->current_balance,2) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3 text-primary">{{settings()->currency}}{{ number_format($merchant->opening_balance,2) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3 text-primary">{{settings()->currency}}{{$t_shop}}</p>
                                ...
                                <div class="card-body p-3 text-right">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="h3 text-primary">{{settings()->currency}}{{$t_parcel_bank}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

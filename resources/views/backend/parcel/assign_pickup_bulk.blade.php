          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="{{ route('parcel.assign-pickup-bulk',['page'=>$request->page]) }}" method="post">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="form-control-wrap deliveryman-search">
                                    <select id="pickupman_bulk" class="form-control delivery_man_search_hub_multiple_parcel" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="assign_pickup_btn" class="btn btn-primary"  >{{ __('levels.cancel') }}</button>
                </div>
            </form>
        </div>
    </div>

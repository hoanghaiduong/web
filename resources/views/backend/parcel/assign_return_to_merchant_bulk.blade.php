      ...
      <div class="modal-content" id="data-modal">
        ...
        <form action="{{ route('parcel.assign-return-to-merchant-bulk',['page'=>$request->page]) }}" method="post">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="form-control-wrap deliveryman-search">
                                <select id="return_todeliveryman_bulk" class="form-control delivery_man_search_hub_multiple_parcel" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('levels.save') }}</button>
                <button type="submit" id="assign_return_merchant_btn" class="btn btn-primary">{{ __('levels.cancel') }}</button>
            </div>
        </form>
    </div>
</div>

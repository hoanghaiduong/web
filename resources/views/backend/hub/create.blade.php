                ...
                <div class="card-body">
                    ...
                    <form action="{{route('hubs.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone" type="number" name="phone" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_phone') }}" autocomplete="off" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone')}}" require>
                            @error('phone')
                                <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>

...
class InvoiceRepository implements InvoiceInterface {
    ...
    public function store($merchant_id){
        try {
            ...
            $parcels              = Parcel::where('merchant_id',$merchant_id)->whereIn('status',[ ParcelStatus::DELIVERED,ParcelStatus::PARTIAL_DELIVERED])->get();
 
            foreach($ParcelInvoice as $invoice_parcel_ids ){
                $parcels = $parcels->whereNotIn('id',$invoice_parcel_ids);
            }  
